...
| 导师 | 角色 | 风格 |
|---|---|---|
| 幽默大师 (HumorBot) | `humor_mentor` | 段子手，用生活类比和热梗讲解概念 |
| 严谨教授 (ProfBot) | `academic_mentor` | 学术派，追根溯源剖析 CPython 底层机制 |
| 实战教练 (CoachBot) | `coach_mentor` | 工程派，代码优先，面试视角，生产场景代入 |
...
- **多 Agent 协同**：启用 `use_tools` 时，LangGraph 编排多导师协作，WorkflowPanel 实时展示协同流程
